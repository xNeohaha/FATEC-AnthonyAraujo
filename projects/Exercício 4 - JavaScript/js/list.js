...
function addFilter() {
  ...
  const filterTasks = list.querySelectorAll("div");

  filterTasks.forEach(task => {
    const filterSpan = task.querySelector("span");
    const filterText = filterSpan.textContent.toLowerCase();

    if (filterText.includes(searchValue)) {
